...
//	Progress bar
		{
			skin->drawslider(b,x,y,ctrl->width,ctrl->height,0,0,((MTProgress*)ctrl)->maxpos,((MTProgress*)ctrl)->pos,false);
		};
		break;
	case MTC_SLIDER:
//	Slider
		{
			...
			skin->drawslider(b,x+ox,y+oy,ow,oh,cm,s.minpos,s.maxpos,s.value,(s.flags & MTCF_OVER) || ((s.flags & MTCF_FOCUSED) && (gi->getcursorphase()>0)));
		};
		break;
	};
}
