...
public:
	...
	MTObject(MTModule *parent,int type,int i){ mtinterface->_ow->create(this,parent,type,i); };
	...
	virtual void MTCT lock(int flags,bool lock){ mtinterface->_ow->lock(this,flags,lock); };
	...
	virtual MTObject* MTCT duplicate(int targettype){ return 0; };
};
//---------------------------------------------------------------------------
#endif
