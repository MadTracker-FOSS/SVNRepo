...
//---------------------------------------------------------------------------
void MTACT a_addbufferslide(sample *dest,sample *source,double a,double i,int count)
{
	_asm{
		push	esi
		push	edi
...
//---------------------------------------------------------------------------
void MTACT a_addbufferslide2(sample *dest1,sample *dest2,sample *source,double a1,double a2,double i1,double i2,int count)
{
	_asm{
		push	esi
		push	edi
